...
function addField(fieldname) {
    ...
    var colorPickerContainer = $('#value-list [data-color]');
    if(colorPickerContainer) {
        var pickerInput = colorPickerContainer.find('.colorpicker-element');
        pickerInput.colorpicker();
        colorPickerContainer.removeAttr('data-color')
    }
}
