...
$config = array(
    ...
    */
    ...
    // 'access_keys' => array(md5('key_for_app_' . 'secret')),
    // 'access_keys' => array(md5('key_for_app_' . env('RF_AKEY_SALT'))),
    'access_keys' => array($params['rf_akey'] ?? ''),
